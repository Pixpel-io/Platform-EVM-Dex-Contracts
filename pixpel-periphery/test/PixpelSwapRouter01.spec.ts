...
enum RouterVersion {
  PixpelSwapRouter01 = 'PixpelSwapRouter01',
  PixpelSwapRouter02 = 'PixpelSwapRouter02'
}

describe('PixpelSwapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.PixpelSwapRouter01]: fixture.router01,
        [RouterVersion.PixpelSwapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.lte(
            {
              [RouterVersion.PixpelSwapRouter01]: 101876,
              [RouterVersion.PixpelSwapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.lte(
            {
              [RouterVersion.PixpelSwapRouter01]: 138770,
              [RouterVersion.PixpelSwapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
