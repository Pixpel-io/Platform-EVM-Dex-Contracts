...
const { Factory, Weth, AmoyFactory, L1XFactory, L1XWETH } = require('../deployedAddress')
async function main() {
  ...
  const router2 = await deployContract(wallet, PixpelSwapRouter02, [L1XFactory, L1XWETH], {
    gasLimit: 9000000,
