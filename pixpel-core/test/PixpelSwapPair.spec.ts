...
describe('PixpelSwapPair', () => {
  ...
  it('mint', async () => {
    ...
    console.log('Token0 balance in pair:', (await token0.balanceOf(pair.address)).toString())
    console.log('Token1 balance in pair:', (await token1.balanceOf(pair.address)).toString())
  ...
  it('swap:gas', async () => {
    ...
    expect(receipt.gasUsed.toNumber()).to.be.within(73402, 73462)
  })
